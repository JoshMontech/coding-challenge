...
const MainHeader = () => {
    ...
    return (
        <header className="relative z-10 flex w-full max-w-[1280px] bg-primary p-[24px] text-primary max:mx-auto">
                        ...
                        >
                            <div className=" mb-[24px] p-[24px]">
                                ...
                                <ul className={`flex flex-col gap-[24px]`}>
                                    ...
                                    <button className="rounded-[6px] bg-inverseSecondary px-[16px] py-[12px] text-white">
                                        Start Free Trial
                                    </button>
